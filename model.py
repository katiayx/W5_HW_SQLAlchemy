...
class Model(db.Model):
    ...
    def __repr__(self):
        """showcases query results in a readable format"""

        return "<Model name=%s brand_name=%s year=%d>" % (self.name, self.brand_name, self.year)
...
class Brand(db.Model):
    ...
    def __repr__(self):
        ...
        return "<Brand name=%s founded=%d headquarters=%s discontinued=%d>" % (self.name, self.founded, self.headquarters, self.discontinued)
